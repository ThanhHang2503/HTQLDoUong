...
(4,'user','user@gmail.com','202cb962ac59075b964b07152d234b70','user'),
(5,'admin','admin@gmail.com','202cb962ac59075b964b07152d234b70','admin'),
(101,'Nguyễn Thị Hương','huongnt@example.com','password1','user'),
(102,'Trần Văn Đức','ductv@example.com','password2','user'),
(103,'Lê Thị Lan','lanlt@example.com','password3','user'),
;
UNLOCK TABLES;
...
(73,'Trà Sữa Trân Châu Đường Nâu',1,'Trà sữa trân châu đường nâu thơm ngon, bán chạy nhất.',45000.00,'2024-04-02 16:42:35'),
(74,'Trà Sữa Kem Cheese',1,'Trà sữa kem phô mai béo ngậy.',50000.00,'2024-04-02 16:42:35'),
(75,'Trà Gừng Mật Ong',2,'Trà gừng ấm nóng, tốt cho sức khỏe.',35000.00,'2024-04-02 16:42:35'),
(76,'Trà Đào Cam Sả',2,'Trà đào cam sả chua ngọt thanh mát.',40000.00,'2024-04-02 16:42:35'),
(77,'Cà Phê Sữa Đá',3,'Cà phê sữa đá đậm đà truyền thống.',35000.00,'2024-04-02 16:42:35'),
(78,'Cà Phê Đen Nóng',3,'Cà phê đen nguyên chất, đắng mạnh.',40000.00,'2024-04-02 16:42:35'),
(79,'Nước Ngọt Coca Cola',4,'Coca Cola có ga lạnh.',12000.00,'2024-04-02 16:42:35'),
(95,'Nước Ngọt Có Ga Mix',4,'Nước ngọt có ga các loại (Coca, Pepsi, Sprite).',15000.00,'2024-04-02 16:42:35'),
(96,'Sinh Tố Bơ',5,'Sinh tố bơ tươi ngon, béo ngậy.',45000.00,'2024-04-02 16:42:35'),
(115,'Sinh Tố Dâu Tây',5,'Sinh tố dâu tây chua ngọt.',40000.00,'2024-04-02 16:42:35'),
(116,'Nước Ép Ổi',6,'Nước ép ổi tươi nguyên chất.',30000.00,'2024-04-02 16:42:35');
UNLOCK TABLES;
...
BEGIN
    ...
    SELECT COUNT(*) INTO user_count FROM accounts WHERE type = 'user';
    RETURN user_count;
END ;;
DELIMITER ;
...
BEGIN
    ...
    SELECT COUNT(*) INTO admin_count FROM accounts WHERE type = 'admin';
    RETURN admin_count;
END ;;
DELIMITER ;
