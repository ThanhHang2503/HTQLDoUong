        ...
        <table id="myTable" class="table container-fluid text-center table-hover table-striped table-bordered">
            <thead>
                <tr>
                    <!-- <th>Mã số</th> -->
                    <th>ID Hóa đơn </th>
                    <th onclick="sortTable(1)">Ngày tạo <span class="fw-bolder"><i class="p-0 btn fa-solid fa-sort"></i></span></th>
                    <th onclick="sortTable(2)">Người lập <span class="fw-bolder"><i class="p-0 btn fa-solid fa-sort"></i></span></th>
                    <th onclick="sortTable(3)">Tên khách <span class="fw-bolder"><i class="p-0 btn fa-solid fa-sort"></i></span></th>
                    <th>Số tiền</th>
                    <th>Thao tác</th>
                </tr>
            </thead>
